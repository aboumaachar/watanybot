...
type ListResponse = { items: Application[]; total: number; page: number; pageSize: number; summary: { total: number; pending: number; approved: number; rejected: number } };
