...
export const MOF_FORMS: Record<string, MOFForm> = {
  ...
  "t7": {
    ...
    preview_url: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0006/preview",
    format: "pdf",
    file_size: "250 KB",
...
8. Keep a copy for your records
    ...
    download_link: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0006/download",
    is_official: true,
  },
  ...
  "t8": {
    ...
    url: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0007/preview",
    preview_url: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0007/preview",
    format: "pdf",
    file_size: "180 KB",
    related_cases: ["spouse", "single-daughter", "widow-daughter", "minor-son", "student-son", "disabled-son", "parent"],
    fields: [
...
8. Keep a copy for your records
    ...
    download_link: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0007/download",
    is_official: true,
  },
  ...
  "t9": {
    ...
    url: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0008/preview",
    preview_url: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0008/preview",
    format: "pdf",
    file_size: "200 KB",
...
9. Certificate is valid for specified period (check expiry date)
    ...
    download_link: "/api/v2/procedures/docs/DOC-WATANY_MOF_HTML-0008/download",
    is_official: true,
  },
};
